...
export const PRESETS: Preset[] = [
  {
    ...
    stripDark: ['#0e0d0b', '#2a2620', '#8c1c13', '#b89a6a', '#d4cabb'],
  ...
  },
  {
    id: 'clean',
    name: 'Clean',
    motto: 'Simplicitas est ultimata sophisticatio',
    dark: {
      '--background': '#09090b',
      '--foreground': '#fafafa',
      '--surface-0': '#09090b',
    ...
    light: {
      ...
      '--text-muted': '#a1a1aa',
      '--accent-projeto': '#2563eb',
      '--accent-tarefa': '#16a34a',
      '--accent-subtarefa': '#7c3aed',
      '--priority-alta': '#dc2626',
      '--priority-media': '#d97706',
      '--priority-baixa': '#16a34a',
      '--status-a-fazer': '#a1a1aa',
      '--status-em-andamento': '#2563eb',
      '--status-pausado': '#d97706',
      '--status-concluido': '#16a34a',
      '--status-cancelado': '#dc2626',
      '--col-a-fazer': '#fafafa',
      '--col-em-andamento': '#eff6ff',
      '--col-pausado': '#fffbeb',
      '--col-concluido': '#f0fdf4',
    },
    stripDark: ['#09090b', '#27272a', '#3b82f6', '#22c55e', '#a78bfa'],
    stripLight: ['#ffffff', '#e4e4e7', '#2563eb', '#16a34a', '#7c3aed'],
  },
];
