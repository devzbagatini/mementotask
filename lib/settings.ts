...
export const PRESETS: Preset[] = [
  {
    ...
    stripDark: ['#0c0a09', '#44403c', '#3b82f6', '#22c55e', '#a855f7'],
    stripLight: ['#fafaf9', '#e7e5e4', '#2563eb', '#16a34a', '#9333ea'],
    dark: {
      '--background': '#0c0a09',
      '--foreground': '#fafaf9',
      '--surface-0': '#0c0a09',
    ...
    light: {
      ...
      '--accent-subtarefa': '#9333ea',
      '--priority-alta': '#dc2626',
      '--priority-media': '#ca8a04',
